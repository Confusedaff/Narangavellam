...
import 'package:narangavellam/home/view/home_page.dart';
                    ...
                    GoRoute(
                        ...
                        pageBuilder: (context, state) {
                          return CustomTransitionPage(
                            ...
                            Center(child: Text('Feed',style: context.headlineSmall?.copyWith(fontWeight:FontWeight.bold ),)),),
                ...
                StatefulShellBranch(routes:[
                    GoRoute(
                        ...
                        pageBuilder: (context, state) {
                          return CustomTransitionPage(
                            child: AppScaffold(body: 
                            Center(child: Center(child: Text('TimeLine',style: context.headlineSmall?.copyWith(fontWeight:FontWeight.bold ),))),),
                            transitionsBuilder: (context,animation,secondaryAnimation,child){
                ...
                StatefulShellBranch(routes:[
                    GoRoute(
                        ...
                        pageBuilder: (context, state) {
                          return CustomTransitionPage(
                            child: AppScaffold(body: 
                            Center(child: Text('Reels',style: context.headlineSmall?.copyWith(fontWeight:FontWeight.bold ),)),),
                            transitionsBuilder: (context,animation,secondaryAnimation,child){
                                return SharedAxisTransition(
                                    animation: animation, 
                                    secondaryAnimation: secondaryAnimation, 
                ...
                StatefulShellBranch(routes:[
                    GoRoute(
                        ...
                        pageBuilder: (context, state) {
                          return CustomTransitionPage(
                            child: AppScaffold(body: 
                            Center(child:ElevatedButton(onPressed: () => context 
                            .read<AppBloc>()
