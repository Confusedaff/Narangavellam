...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get haveSeenAllRecentPosts => 'You are all caught up';

  @override
  String get haveSeenAllRecentPostsInPast3Days =>
      'You have seen all new posts from the past 3 days.';
  ...
  @override
  String get notShowAgainText => 'Dont not show again';
  ...
  String get fullNameEditDescription =>
      'Help people discover your account by using the name yor are known by: either your full name, nickname, or business name.\n\nYou can only change your name twice within 14 days.';

  @override
  String usernameEditDescription(String username) {
    return 'You will be able to change your username back to $username for another 14 days';
  }
  ...
  @override
  String get noAccountText => 'Don not have an account?';
