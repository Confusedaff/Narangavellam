...
import 'package:insta_blocks/src/media_carousel_settings.dart';
import 'package:insta_blocks/src/widgets/attachments/widgets/thumbnail/thumbnail.dart';
import 'package:insta_blocks/src/widgets/widgets.dart';
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, currentIndex, _) {
        final shouldPlay = currentIndex == realIndex;
          ...
          return const SizedBox(child: Text('inline video'),);
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, currentIndex, _) {
        final shouldPlay = currentIndex == realIndex;
          ...
          return const SizedBox(child: Text('inline_video'),);
        // return InlineVideo(
        //   key: ValueKey(media.id),
        //   videoSettings: VideoSettings.build(
        //     id: media.id,
